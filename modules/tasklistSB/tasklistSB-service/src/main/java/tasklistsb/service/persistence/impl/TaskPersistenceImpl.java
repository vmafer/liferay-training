...
import tasklistsb.service.persistence.TaskUtil;
import tasklistsb.service.persistence.impl.constants.TasklistPersistenceConstants;
...
public class TaskPersistenceImpl
	...
	@Override
	@Reference(
		target = TasklistPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = TasklistPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
