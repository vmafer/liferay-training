...
import tasklistsb.model.TaskModel;

/**
 * The base model implementation for the Task service. Represents a row in the &quot;Tasklist_Task&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class TaskModelImpl extends BaseModelImpl<Task> implements TaskModel {
	 ...
	 */
	public static final String TABLE_NAME = "Tasklist_Task";
	...
	public static final String TABLE_SQL_CREATE =
		"create table Tasklist_Task (uuid_ VARCHAR(75) null,taskId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,title VARCHAR(75) null)";

	public static final String TABLE_SQL_DROP = "drop table Tasklist_Task";

	public static final String ORDER_BY_JPQL = " ORDER BY task.taskId ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY Tasklist_Task.taskId ASC";
