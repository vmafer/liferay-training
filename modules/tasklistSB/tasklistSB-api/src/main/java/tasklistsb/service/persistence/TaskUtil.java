...
package tasklistsb.service.persistence;
...
/**
 * The persistence utility for the task service. This utility wraps <code>tasklistsb.service.persistence.impl.TaskPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class TaskUtil {
	...
	public static Task findByUuid_First(
		...
		throws tasklistsb.exception.NoSuchTaskException {
